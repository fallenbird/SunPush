...
static BOOL __stdcall ReadProcMemoryFromIMallocHash(HANDLE pData, DWORD64 lpBaseAddress, PVOID lpBuffer, DWORD nSize, PDWORD lpNumberOfBytesRead) {
  ...
  *lpNumberOfBytesRead = 0;
  ...
  if ( lpBaseAddress >= pHashEntry->dwESPOffset && lpBaseAddress <= (pHashEntry->dwESPOffset+pHashEntry->dwESPLen) ) {
  ...
  if ( lpBaseAddress >= pHashEntry->dwEIPOffset && lpBaseAddress <= (pHashEntry->dwEIPOffset+pHashEntry->dwEIPLen) ) {
